...
namespace TicTacToe
{
    class Program
    {
        static void Main(string[] args)
        {
			...
			Console.WriteLine("Final Project for Game Programming class.");
			Console.WriteLine("-+-+-+-+-+-+-+-+-+-+-+-\n");
			Console.WriteLine("Done by Akshit Pathania \n");
			Console.ResetColor();

			while (NewGame)
			{
				Console.WriteLine("Are you ready to play some Tic-Tac-Toe:");
